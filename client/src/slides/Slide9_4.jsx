  ...
  return (
    ...
    >
      ...
      <div className="mt-auto pt-4 border-t border-white/[0.08] flex justify-between items-center opacity-60">
        <div className="text-[12px] font-extrabold uppercase tracking-[2px]">Scientific Hypotheses & Goals</div>
        <div className="text-[12px] font-extrabold uppercase tracking-[2px] text-[#FFE600]">04 / 06</div>
      </div>
    </motion.div>
  );
};
