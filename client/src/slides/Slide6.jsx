  ...
  return (
    ...
    >
      ...
      <div className="mt-6 pt-4 border-t border-white/5 flex justify-between items-center opacity-50">
        <div className="text-[10px] font-extrabold uppercase tracking-[2px] text-white/60">Project Timeline & Analysis</div>
        <div className="text-[10px] font-extrabold uppercase tracking-[2px] text-[#FFE600]">06 / 06</div>
      </div>
    </motion.div>
  );
};
