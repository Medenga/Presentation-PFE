...
const Slide10 = () => {
  return (
    <motion.div 
      initial={{ opacity: 0 }} 
      animate={{ opacity: 1 }} 
      className="relative w-[1280px] h-[720px] bg-[#313130] text-white flex flex-col items-center justify-center p-[60px_80px] font-urbanist text-center"
    >
      ...
      <div className="absolute bottom-0 left-0 w-full px-20 pb-10 z-20">
        <div className="pt-4 border-t border-white/10 flex justify-between items-center text-[10px] font-extrabold uppercase tracking-widest">
          <div className="text-white">Numéro d'équipe: #PFE25-R-474</div>
          <div className="text-white text-xs font-black">
            10 <span className="text-[#FFE600]">/</span> 10
          </div>
        </div>
      </div>
    </motion.div>
